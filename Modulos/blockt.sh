...
echo -e "\E[44;1;37m           UGNIASIENE TORRENT UZKARDA           \E[0m"
echo ""
if [[ -e "$arq" ]]; then
	fun_fireoff () {
...
fun_spn1 () {
	...
	echo -ne "\033[1;31mSALINAMA UZKARDA\033[1;32m.\033[1;33m.\033[1;31m. \033[1;32m"
	helice
	echo -e "\e[1DOk"
}
read -p "$(echo -e "\033[1;32mNORITE PASALINTI UZKARDOS TAISYKLES? \033[1;33m[s/n]:\033[1;37m") " -e -i n resp
if [[ "$resp" = 's' ]]; then
	echo ""	
	fun_spn1
	echo ""
	echo -e "\033[1;33mTORRENT LEIDZIAMI !\033[0m"
	echo ""
	echo -e "\033[1;32mUZKARDA SEKMINGAI PASALINTA !"
	echo ""
	if [[ -e /etc/openvpn/openvpn-status.log ]]; then
		echo -e "\033[1;31m[\033[1;33m!\033[1;31m]\033[1;33m IS NAUJO PALEISKITE SISTEMA, NOREDAMI UZBAIGTI"
		echo ""
		read -p "$(echo -e "\033[1;32mPALEISTI IS NAUJO DABAR \033[1;31m? \033[1;33m[s/n]:\033[1;37m ")" -e -i s respost
		echo ""
		if [[ "$respost" = 's' ]]; then
			echo -ne "\033[1;31mPerkraunama" 
...
echo -e "\033[1;31m[\033[1;33m!\033[1;31m]\033[1;33m SI FUNKCIJA TESTUOJAMA"
echo ""
read -p "$(echo -ne "\033[1;32mNORITE TAIKYTI UZKARDOS TAISYKLES ? \033[1;33m[s/n]:\033[1;37m") " -e -i n resp
if [[ "$resp" = 's' ]]; then
echo ""
echo -ne "\033[1;33mTOLIAU PATVIRTINKITE SAVO IP: \033[1;37m"; read -e -i $IP IP
if [[ -z "$IP" ]];then
echo ""
echo -e "\033[1;31mBlogas IP\033[1;32m"
sleep 1
echo ""
read -p "Iveskite savo IP: " IP
fi
echo ""
sleep 1
fun_fireon () {
...
fun_spn2 () {
	...
	echo -ne "\033[1;32mUZKARDOS TAIKYMAS\033[1;32m.\033[1;33m.\033[1;31m. \033[1;32m"
	helice
	echo -e "\e[1DOk"
}
fun_spn2
echo ""
echo -e "\033[1;33mBLOKAVIMAS\033[1;37m TORRENT \033[1;33mAKTYVUOTAS !\033[0m"
echo ""
echo -e "\033[1;32mSEKMINGAI PRITAIKYTA UZKARDA !"
sleep 3
menu
else
	sleep 1
