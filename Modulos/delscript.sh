#!/bin/bash
clear
echo -e "\033[1;32mSSHPUS MANAGER SCRIPTO PASALINIMAS\033[1;33m"
read -p "Norite pasalinti? [s/n] " resp
if [[ "$resp" = s || "$resp" = S ]];then
    ...
    clear
    echo -e "\033[1;36mDekojame, kad naudojates SSHPLUS MANAGER SCRIPTU\033[1;33m"
    sleep 2
    cat /dev/null > ~/.bash_history && history -c && exit 0
else
    echo -e "\033[1;32mOk grizti i meniu\033[1;33m"
    sleep 3
    menu
fi