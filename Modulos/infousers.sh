#!/bin/bash
clear
echo -e "\E[44;1;37m Vartotojas      Slaptazodis   Limitas    Galiojimas \E[0m"
echo ""
...
then
data="\033[1;33mNerastas\033[0m"
else
    databr="$(date -d "$datauser" +"%Y%m%d")"
    hoje="$(date -d today +"%Y%m%d")"
    if [ $hoje -ge $databr ]
    then
    data="\033[1;31mPasibaiges\033[0m"
    else
    dat="$(date -d"$datauser" '+%Y-%m-%d')"
    data=$(echo -e "$((($(date -ud $dat +%s)-$(date -ud $(date +%Y-%m-%d) +%s))/86400)) \033[1;37mDienos\033[0m")
    fi
fi
...
echo -e "\033[1;33m• \033[1;36mIS VISO VARTOTOJU\033[1;37m $_tuser \033[1;33m• \033[1;32mPRISIJUNGE\033[1;37m: $_onli \033[1;33m• \033[1;31mPASIBAIGE\033[1;37m: $_expuser \033[1;33m•\033[0m"
