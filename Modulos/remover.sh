...
clear
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%32s%s%-13s\n' "Pasalinti SSH vartotoja" ; tput sgr0
echo ""
echo -e "\033[1;31m[\033[1;36m1\033[1;31m]\033[1;33m PASALINTI VARTOTOJA"
echo -e "\033[1;31m[\033[1;36m2\033[1;31m]\033[1;33m PASALINTI VISUS VARTOTOJUS"
echo -e "\033[1;31m[\033[1;36m3\033[1;31m]\033[1;33m ATGAL"
echo ""
read -p "$(echo -e "\033[1;32mKA JUS NORITE DARYTI\033[1;31m ?\033[1;37m : ")" -e -i 1 resp
if [[ "$resp" = "1" ]]; then
clear
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%32s%s%-13s\n' "Pasalinti SSH vartotoja" ; tput sgr0
echo ""
echo -e "\033[1;33mVARTOTOJU SARASAS: \033[0m"
echo""
...
if [[ -z $option ]]; then
	tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "  Tuscias arba negaliojantis vartotojas!   " ; echo "" ; tput sgr0
	exit 1
elif [[ -z $user ]]; then
	tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo " Tuscias arba negaliojantis vartotojas! " ; echo "" ; tput sgr0
	exit 1
	...
	if cat /etc/passwd |grep -w $user > /dev/null; then
		...
		echo -e "\E[41;1;37m Vartotojas $user sekmingai pasalintas! \E[0m"
		...
		if [[ `grep -c $user /tmp/rem` -eq 0 ]]; then
		    ...
		    echo ""
			tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Vartotojas prisijunges. Atjungiama..." ; tput sgr0
			pkill -f "$user" > /dev/null 2>&1
			deluser --force $user > /dev/null 2>&1
			echo -e "\E[41;1;37m Vartotojas $user sekmingai pasalintas! \E[0m"
			grep -v ^$user[[:space:]] /root/usuarios.db > /tmp/ph ; cat /tmp/ph > /root/usuarios.db
	...
	tput setaf 7 ; tput setab 4 ; tput bold ; printf '%32s%s%-13s\n' "Pasalinti SSH vartotoja" ; tput sgr0
	echo ""
	echo -ne "\033[1;33mTIKRAI NORITE PASALINTI VISUS VARTOTOJUS \033[1;37m[s/n]: "; read opc	
	if [[ "$opc" = "s" ]]; then
	echo -e "\n\033[1;33mPalaukite\033[1;32m.\033[1;31m.\033[1;33m.\033[0m"
        ...
        rm *.zip > /dev/null 2>&1
		echo -e "\n\033[1;32mVARTOTOJAI PASALINTI SEKMINGAI!\033[0m"
		sleep 2
		menu
	else
		echo -e "\n\033[1;31mGriztama i meniu...\033[0m"
		sleep 2
		menu
	fi
elif [[ "$resp" = "3" ]]; then
